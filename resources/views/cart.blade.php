                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-thumbnail">
                                    ...
                                    <div class="cart-product__item">
                                        <a href="#">
                                            <img src="{{ asset($product->model->image) }}" style="width: 100px;" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                        </a>
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                        <a href="{{ route('cart.decrease', ['id' => $product->rowId, 'qty' => $product->qty]) }}" class="quantity-minus">-</a>
