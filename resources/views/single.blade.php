        ...
        <div class="product-details">
            ...
            <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                <div class="product-details-info">
                    ...
                    <p class="product-details-info-text">{{ $product->detail }}</p>
                    ...
                    <div class="quantity">
                        <a href="{{ route('cart.decrease', ['id' => $product->rowId]) }}" class="quantity-minus">-</a>
                        <input title="Qty" class="email input-text qty text" name="qty" type="text" value="2">
                        <a href="{{ route('cart.increase', ['id' => $product->rowId]) }}" class="quantity-plus">+</a>
                    </div>
